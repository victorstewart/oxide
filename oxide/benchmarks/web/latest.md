...
| --- | --- |
| Status | `collected` |
| Artifact | `/tmp/oxide-webgpu-browser-allocation-invariance.json` |
| Capture phase | `benchmark-report` |
| Timing source | `untraced-baseline-report` |
| Events | `78524` |
| GPU-related events | `47503` |
| WebGPU/Dawn events | `1397` |
| ANGLE events | `1` |
| Renderer events | `703` |
| Duration us | `1233031` |
| Category count | `25` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 22242 | 3320 | 1916 | 58 | 41 | 186865 |
| `id_mask_ab` | 55182 | 6496 | 4055 | 107 | 78 | 473236 |
| `upload_ab` | 150035 | 11322 | 7476 | 183 | 128 | 1271533 |
| `upload_scratch_ab` | 46675 | 3871 | 2806 | 90 | 18 | 447563 |
| `effect_uniform_ab` | 220475 | 6020 | 3192 | 88 | 18 | 1662783 |
| `backdrop_batch_ab` | 45123 | 3703 | 2669 | 88 | 18 | 355109 |
| `scene3d_ab` | 38206 | 6638 | 5133 | 172 | 36 | 251476 |
| `mixed_matrix` | 38058 | 3602 | 2647 | 88 | 18 | 263973 |
| `layer_effects_matrix` | 39312 | 3591 | 2640 | 88 | 18 | 312267 |
| `command_family_matrix` | 28528 | 3589 | 2640 | 88 | 18 | 205822 |
| `draw_state_cache_ab` | 29615 | 3601 | 2630 | 88 | 18 | 231072 |
| `clip_state_cache_ab` | 29200 | 3528 | 2617 | 88 | 18 | 140896 |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 17.600 | `yes` | 13041664 | 13041664 | 0 | 1217824 | 1253654 | 35830 | 1 | 1 |
| `id_mask_ab` | 62.500 | `yes` | 13041664 | 13041664 | 0 | 1254557 | 1301429 | 46872 | 1 | 1 |
| `upload_ab` | 146.200 | `yes` | 13041664 | 13041664 | 0 | 1301565 | 1326678 | 25113 | 1 | 1 |
| `upload_scratch_ab` | 45.600 | `yes` | 13041664 | 13041664 | 0 | 1327036 | 1338520 | 11484 | 1 | 1 |
| `effect_uniform_ab` | 212.100 | `yes` | 13041664 | 13041664 | 0 | 1338642 | 1358384 | 19742 | 1 | 1 |
| `backdrop_batch_ab` | 52.600 | `yes` | 13041664 | 13041664 | 0 | 1358526 | 1383507 | 24981 | 1 | 1 |
| `scene3d_ab` | 38.100 | `yes` | 13041664 | 13041664 | 0 | 1383629 | 1409375 | 25746 | 1 | 1 |
| `mixed_matrix` | 37.400 | `yes` | 13041664 | 13041664 | 0 | 1409511 | 1420367 | 10856 | 1 | 1 |
| `layer_effects_matrix` | 46.100 | `yes` | 13041664 | 13041664 | 0 | 1420499 | 1430869 | 10370 | 1 | 1 |
| `command_family_matrix` | 30.200 | `yes` | 13041664 | 13041664 | 0 | 1440349 | 1450484 | 10135 | 1 | 1 |
| `draw_state_cache_ab` | 27.900 | `yes` | 13041664 | 13041664 | 0 | 1450642 | 1462917 | 12275 | 1 | 1 |
| `clip_state_cache_ab` | 20.900 | `yes` | 13041664 | 13041664 | 0 | 1463147 | 1474789 | 11642 | 1 | 1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.wasm_allocation_audit.current_rows` | 14 checked / 13 excluded | 3304 | 65128 | 0 | 0 | 6.556 | 129.222 | 174 | 7 | 144 |
...
| --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.wasm_allocation_invariance.current_rows` | `shared-submit-boundary-profile` | `web.wasm.webgpu.frame_loop` | 14 | 1 | 236 | 4652 | 0 | 174 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.id_mask_compositor.current_vs_legacy_upload` | 0.075 | 0.167 | 2.222 | 12 | 12 | 1120 | 308320 | 9600 | 307200 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload.current_dirty_vs_legacy_full` | 0.058 | 2.875 | 49.286 | 16384 | 4194304 | 11291 | 11582 | 1.026 | 0.025 | 0.117 | 4.667 | 16384 | 262144 | 12334 | 10791 | 0.875 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.effect_uniform.batched_vs_legacy_write_each` | 0.208 | 0.217 | 1.040 | 1351604 | 1540079 | 1.139 | 1 | 48 | 48 | 48 | 48 | 48 | 48 | 48 | 51 | 51 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.mixed_text_image_effects.current_vs_legacy_rebind_unbatched` | 0.075 | 0.083 | 1.111 | 114 | 114 | 8 | 114 | 7 | 102 | 5 | 114 | 1 | 2 | 2 | 2 | 6 | 6 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.draw_state_cache.current_vs_legacy_rebind` | 0.108 | 0.200 | 1.846 | 1024 | 1024 | 1 | 1024 | 1 | 1024 | 1 | 1024 |
...
| --- | --- | ---: | ---: | ---: | --- |
| `app` | 320x240 | 0 | 0 | 0.000 | `/tmp/oxide-webgpu-browser-allocation-invariance.png` |
