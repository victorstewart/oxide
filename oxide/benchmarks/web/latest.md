...
| --- | --- |
| Status | `collected` |
| Artifact | `/tmp/oxide-webgpu-browser-reused-matrix-damage-budgeted.json` |
| Capture phase | `benchmark-report` |
| Timing source | `untraced-baseline-report` |
| Events | `77638` |
| GPU-related events | `47071` |
| WebGPU/Dawn events | `1389` |
| ANGLE events | `1` |
| Renderer events | `677` |
| Duration us | `1213618` |
| Category count | `25` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 18067 | 3294 | 1913 | 55 | 36 | 167465 |
| `id_mask_ab` | 54748 | 6636 | 4113 | 109 | 81 | 485487 |
| `upload_ab` | 145932 | 11585 | 7621 | 185 | 137 | 1278616 |
| `upload_scratch_ab` | 46755 | 3876 | 2776 | 88 | 18 | 411846 |
| `effect_uniform_ab` | 211993 | 5865 | 3155 | 88 | 18 | 1581567 |
| `backdrop_batch_ab` | 45661 | 3703 | 2677 | 88 | 18 | 347442 |
| `scene3d_ab` | 38118 | 6655 | 5136 | 172 | 36 | 241759 |
| `mixed_matrix` | 38162 | 3596 | 2641 | 88 | 18 | 257026 |
| `layer_effects_matrix` | 38123 | 3597 | 2645 | 88 | 18 | 296572 |
| `command_family_matrix` | 21060 | 3438 | 2582 | 88 | 18 | 204722 |
| `draw_state_cache_ab` | 30008 | 3571 | 2618 | 88 | 18 | 218729 |
| `clip_state_cache_ab` | 21476 | 3437 | 2581 | 88 | 18 | 130983 |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 18.200 | `yes` | 13041664 | 13041664 | 0 | 1217860 | 1253654 | 35794 | 1 | 1 |
| `id_mask_ab` | 53.800 | `yes` | 13041664 | 13041664 | 0 | 1254557 | 1302005 | 47448 | 1 | 1 |
| `upload_ab` | 145.600 | `yes` | 13041664 | 13041664 | 0 | 1302141 | 1326678 | 24537 | 1 | 1 |
| `upload_scratch_ab` | 46.500 | `yes` | 13041664 | 13041664 | 0 | 1327036 | 1338532 | 11496 | 1 | 1 |
| `effect_uniform_ab` | 204.000 | `yes` | 13041664 | 13041664 | 0 | 1338654 | 1358395 | 19741 | 1 | 1 |
| `backdrop_batch_ab` | 45.900 | `yes` | 13041664 | 13041664 | 0 | 1358537 | 1383518 | 24981 | 1 | 1 |
| `scene3d_ab` | 36.800 | `yes` | 13041664 | 13041664 | 0 | 1383640 | 1409380 | 25740 | 1 | 1 |
| `mixed_matrix` | 29.800 | `yes` | 13041664 | 13041664 | 0 | 1409516 | 1420389 | 10873 | 1 | 1 |
| `layer_effects_matrix` | 38.000 | `yes` | 13041664 | 13041664 | 0 | 1420505 | 1430863 | 10358 | 1 | 1 |
| `command_family_matrix` | 21.100 | `yes` | 13041664 | 13041664 | 0 | 1440343 | 1592986 | 152643 | 1 | 1 |
| `draw_state_cache_ab` | 29.500 | `yes` | 13041664 | 13041664 | 0 | 1450648 | 1461039 | 10391 | 1 | 1 |
| `clip_state_cache_ab` | 21.500 | `yes` | 13041664 | 13041664 | 0 | 1461269 | 1474795 | 13526 | 1 | 1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.id_mask_compositor.current_vs_legacy_upload` | 0.092 | 0.167 | 1.818 | 12 | 12 | 1120 | 308320 | 9600 | 307200 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload.current_dirty_vs_legacy_full` | 0.050 | 2.842 | 56.833 | 16384 | 4194304 | 11373 | 14374 | 1.264 | 0.025 | 0.100 | 4.000 | 16384 | 262144 | 13332 | 11208 | 0.841 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload_scratch.current_reuse_vs_legacy_temp_alloc` | 0.367 | 0.442 | 1.205 | 0 | 72 | 0 | 884736 | 4194304 | 4194304 | 786432 | 786432 | 24 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.effect_uniform.batched_vs_legacy_write_each` | 0.217 | 0.217 | 1.000 | 1326899 | 1375669 | 1.037 | 1 | 48 | 48 | 48 | 48 | 48 | 48 | 48 | 51 | 51 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.command_family_matrix.current_vs_legacy_rebind` | 0.108 | 0.167 | 1.538 | 649 | 649 | 3 | 649 | 2 | 648 | 1 | 649 | 64/64 | 64/64 | 288/288 | 0/0 |
...
| --- | --- | ---: | ---: | ---: | --- |
| `app` | 320x240 | 0 | 0 | 0.000 | `/tmp/oxide-webgpu-browser-reused-matrix-damage-budgeted.png` |
