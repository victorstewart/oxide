...
| --- | --- |
| Status | `collected` |
| Artifact | `/tmp/oxide-webgpu-browser-upload-gpu-timestamps.json` |
| Capture phase | `benchmark-report` |
| Timing source | `untraced-baseline-report` |
| Events | `74042` |
| GPU-related events | `43377` |
| WebGPU/Dawn events | `1262` |
| ANGLE events | `1` |
| Renderer events | `597` |
| Duration us | `1394892` |
| Category count | `25` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 32340 | 3593 | 2020 | 56 | 50 | 256234 |
| `id_mask_ab` | 83382 | 7146 | 4292 | 109 | 71 | 706137 |
| `upload_ab` | 174223 | 10596 | 6972 | 184 | 92 | 1475583 |
| `upload_scratch_ab` | 66439 | 4221 | 2852 | 92 | 18 | 583442 |
| `effect_uniform_ab` | 274966 | 6728 | 3372 | 90 | 18 | 2043150 |
| `backdrop_batch_ab` | 66485 | 4038 | 2771 | 90 | 18 | 495681 |
| `scene3d_ab` | 66563 | 7289 | 5359 | 180 | 36 | 456739 |
| `mixed_matrix` | 24803 | 1924 | 1362 | 47 | 9 | 179155 |
| `layer_effects_matrix` | 24916 | 1959 | 1392 | 48 | 9 | 165707 |
| `command_family_matrix` | 17357 | 1923 | 1422 | 49 | 14 | 135342 |
| `draw_state_cache_ab` | 40821 | 3864 | 2711 | 90 | 18 | 324406 |
| `clip_state_cache_ab` | 33254 | 3675 | 2672 | 90 | 18 | 232352 |

## Benchmark Marks

| Mark | Duration ms | Trace label | WASM before bytes | WASM after bytes | WASM growth bytes |
| --- | ---: | --- | ---: | ---: | ---: |
| `frame_loop` | 28.100 | `yes` | 13041664 | 13041664 | 0 |
| `id_mask_ab` | 558.400 | `yes` | 13041664 | 13041664 | 0 |
| `upload_ab` | 174.300 | `yes` | 13041664 | 13041664 | 0 |
| `upload_scratch_ab` | 66.500 | `yes` | 13041664 | 13041664 | 0 |
| `effect_uniform_ab` | 242.500 | `yes` | 13041664 | 13041664 | 0 |
| `backdrop_batch_ab` | 66.500 | `yes` | 13041664 | 13041664 | 0 |
| `scene3d_ab` | 119.800 | `yes` | 13041664 | 13041664 | 0 |
| `mixed_matrix` | 24.500 | `yes` | 13041664 | 13041664 | 0 |
| `layer_effects_matrix` | 24.900 | `yes` | 13041664 | 13041664 | 0 |
| `command_family_matrix` | 116.600 | `yes` | 13041664 | 13041664 | 0 |
| `draw_state_cache_ab` | 50.000 | `yes` | 13041664 | 13041664 | 0 |
| `clip_state_cache_ab` | 50.000 | `yes` | 13041664 | 13041664 | 0 |
...
| `mixed_text_image_effects` | `covered` | `coverage` | 1 | 9 |
| `layer_damage_effects` | `covered` | `coverage` | 1 | 7 |
| `command_family_matrix` | `covered` | `coverage` | 1 | 6 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.id_mask_compositor.current_vs_legacy_upload` | 0.142 | 0.192 | 1.353 | 12 | 12 | 1120 | 308320 | 9600 | 307200 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload.current_dirty_vs_legacy_full` | 0.050 | 2.983 | 59.667 | 16384 | 4194304 | 11206 | 18916 | 1.688 | 0.025 | 0.092 | 3.667 | 16384 | 262144 | 21874 | 20291 | 0.928 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload_scratch.current_reuse_vs_legacy_temp_alloc` | 0.358 | 0.442 | 1.233 | 0 | 72 | 0 | 884736 | 4194304 | 4194304 | 786432 | 786432 | 24 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.effect_uniform.batched_vs_legacy_write_each` | 0.200 | 0.217 | 1.083 | 1839194 | 1477165 | 0.803 | 1 | 48 | 48 | 48 | 48 | 48 | 48 | 48 | 51 | 51 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.backdrop_batch.coalesced_vs_per_backdrop_copy` | 0.025 | 0.075 | 3.000 | 1 | 1 | 12 | 12 | 12 | 12 | 1 | 12 | 4 | 15 |
...
| --- | --- | ---: | ---: | ---: | --- |
| `app` | 320x240 | 0 | 0 | 0.000 | `/tmp/oxide-webgpu-browser-upload-gpu-timestamps.png` |
