...
| `web.wasm.webgpu.draw_state_cache.legacy_rebind` | `webgpu-draw-state-cache-legacy-rebind` | 3 | 12 | 36 | 0.208 | 0.208 | 0.208 | 0.208 | 0.200 | ms/frame | `draws=1024;draw_items=1024;draw_pipeline_binds=1024;draw_bind_group_binds=1024;draw_scissor_sets=1024;solid_tris=0;image_draws=1024;image_mesh_draws=0;nine_slice_draws=0;glyph_quads=0;sdf_glyph_quads=0;clip_depth_peak=0;damage_rects=0;layer_draws=0;scene3d_draws=0;id_mask_draws=0;backdrop_draws=0;visual_effect_draws=0;effect_uniform_writes=0;effect_uniform_bytes=0;effect_uniform_slots=0;spinner_draws=0;camera_bg_draws=0;render_passes=1;passes=clear:0/draw:1/scene3d:0/scene3d_overlay:0/idmask:0+0+0+0/present:0;texture_copies=0;command_buffers=1;gpu_ts_passes=1;gpu_ts_total_ns=63083;gpu_ts_max_ns=63083;buffer_upload_bytes=155664;texture_upload_bytes=0;buffer_grows=0;texture_creates=0;bind_group_creates=0;pipeline_creates=0;sampler_creates=0;mesh3d_creates=0;image_upload_temp_allocs=0;image_upload_temp_bytes=0;image_upload_scratch_bytes=4194304;image_upload_scratch_grows=0;cpu_scratch_bytes=5128352;cpu_scratch_grows=0;cpu_scratch_growth_bytes=0;image=256x256;expected_draw_items=1024;missed120=0.000;hitch120=0.000;missed60=0.000;hitch60=0.000` |
| `web.wasm.webgpu.clip_state_cache.current` | `webgpu-clip-state-cache-current` | 3 | 12 | 36 | 0.067 | 0.075 | 0.075 | 0.075 | 0.069 | ms/frame | `draws=512;draw_items=512;draw_pipeline_binds=1;draw_bind_group_binds=1;draw_scissor_sets=16;solid_tris=0;image_draws=512;image_mesh_draws=0;nine_slice_draws=0;glyph_quads=0;sdf_glyph_quads=0;clip_depth_peak=2;damage_rects=0;layer_draws=0;scene3d_draws=0;id_mask_draws=0;backdrop_draws=0;visual_effect_draws=0;effect_uniform_writes=0;effect_uniform_bytes=0;effect_uniform_slots=0;spinner_draws=0;camera_bg_draws=0;render_passes=1;passes=clear:0/draw:1/scene3d:0/scene3d_overlay:0/idmask:0+0+0+0/present:0;texture_copies=0;command_buffers=1;gpu_ts_passes=1;gpu_ts_total_ns=24084;gpu_ts_max_ns=24084;buffer_upload_bytes=77840;texture_upload_bytes=0;buffer_grows=0;texture_creates=0;bind_group_creates=0;pipeline_creates=0;sampler_creates=0;mesh3d_creates=0;image_upload_temp_allocs=0;image_upload_temp_bytes=0;image_upload_scratch_bytes=4194304;image_upload_scratch_grows=0;cpu_scratch_bytes=5128352;cpu_scratch_grows=0;cpu_scratch_growth_bytes=0;image=256x256;expected_draw_items=512;expected_clip_runs=16;expected_clip_depth=2;missed120=0.000;hitch120=0.000;missed60=0.000;hitch60=0.000` |
| `web.wasm.webgpu.clip_state_cache.legacy_rebind` | `webgpu-clip-state-cache-legacy-rebind` | 3 | 12 | 36 | 0.117 | 0.117 | 0.117 | 0.117 | 0.114 | ms/frame | `draws=512;draw_items=512;draw_pipeline_binds=512;draw_bind_group_binds=512;draw_scissor_sets=512;solid_tris=0;image_draws=512;image_mesh_draws=0;nine_slice_draws=0;glyph_quads=0;sdf_glyph_quads=0;clip_depth_peak=2;damage_rects=0;layer_draws=0;scene3d_draws=0;id_mask_draws=0;backdrop_draws=0;visual_effect_draws=0;effect_uniform_writes=0;effect_uniform_bytes=0;effect_uniform_slots=0;spinner_draws=0;camera_bg_draws=0;render_passes=1;passes=clear:0/draw:1/scene3d:0/scene3d_overlay:0/idmask:0+0+0+0/present:0;texture_copies=0;command_buffers=1;gpu_ts_passes=1;gpu_ts_total_ns=24207;gpu_ts_max_ns=24207;buffer_upload_bytes=77840;texture_upload_bytes=0;buffer_grows=0;texture_creates=0;bind_group_creates=0;pipeline_creates=0;sampler_creates=0;mesh3d_creates=0;image_upload_temp_allocs=0;image_upload_temp_bytes=0;image_upload_scratch_bytes=4194304;image_upload_scratch_grows=0;cpu_scratch_bytes=5128352;cpu_scratch_grows=0;cpu_scratch_growth_bytes=0;image=256x256;expected_draw_items=512;expected_clip_runs=16;expected_clip_depth=2;missed120=0.000;hitch120=0.000;missed60=0.000;hitch60=0.000` |
...
| --- | --- |
| Status | `collected` |
| Artifact | `/tmp/oxide-webgpu-browser-js-heap-attribution.json` |
| Capture phase | `benchmark-report` |
| Timing source | `untraced-baseline-report` |
| Events | `82208` |
| GPU-related events | `48111` |
| WebGPU/Dawn events | `1420` |
| ANGLE events | `1` |
| Renderer events | `654` |
| Duration us | `1481979` |
| Category count | `25` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 27128 | 3482 | 1934 | 55 | 43 | 271372 |
| `id_mask_ab` | 86783 | 6721 | 4123 | 110 | 75 | 749736 |
| `upload_ab` | 171266 | 10509 | 6872 | 184 | 92 | 1476342 |
| `upload_scratch_ab` | 63280 | 4401 | 2843 | 92 | 18 | 705287 |
| `effect_uniform_ab` | 270645 | 6702 | 3373 | 90 | 18 | 2018086 |
| `backdrop_batch_ab` | 78812 | 4271 | 2829 | 90 | 18 | 539620 |
| `scene3d_ab` | 71187 | 7381 | 5374 | 176 | 36 | 474992 |
| `mixed_matrix` | 54451 | 4026 | 2776 | 91 | 18 | 389383 |
| `layer_effects_matrix` | 54906 | 4125 | 2859 | 90 | 23 | 431986 |
| `command_family_matrix` | 38079 | 3851 | 2748 | 91 | 18 | 337347 |
| `draw_state_cache_ab` | 47546 | 3956 | 2747 | 90 | 18 | 364112 |
| `clip_state_cache_ab` | 37082 | 3784 | 2708 | 90 | 18 | 265702 |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 25.200 | `yes` | 13041664 | 13041664 | 0 | 1215768 | 1257961 | 42193 | 1 | 1 |
| `id_mask_ab` | 87.000 | `yes` | 13041664 | 13041664 | 0 | 1258864 | 1297844 | 38980 | 1 | 1 |
| `upload_ab` | 170.700 | `yes` | 13041664 | 13041664 | 0 | 1297980 | 1329061 | 31081 | 1 | 1 |
| `upload_scratch_ab` | 64.300 | `yes` | 13041664 | 13041664 | 0 | 1329419 | 1339170 | 9751 | 1 | 1 |
| `effect_uniform_ab` | 253.100 | `yes` | 13041664 | 13041664 | 0 | 1339292 | 1364349 | 25057 | 1 | 1 |
| `backdrop_batch_ab` | 70.100 | `yes` | 13041664 | 13041664 | 0 | 1364491 | 1392293 | 27802 | 1 | 1 |
| `scene3d_ab` | 63.200 | `yes` | 13041664 | 13041664 | 0 | 1392415 | 1413631 | 21216 | 1 | 1 |
| `mixed_matrix` | 54.400 | `yes` | 13041664 | 13041664 | 0 | 1413767 | 1423727 | 9960 | 1 | 1 |
| `layer_effects_matrix` | 55.800 | `yes` | 13041664 | 13041664 | 0 | 1423859 | 1433335 | 9476 | 1 | 1 |
| `command_family_matrix` | 37.600 | `yes` | 13041664 | 13041664 | 0 | 1442815 | 1452018 | 9203 | 1 | 1 |
| `draw_state_cache_ab` | 46.100 | `yes` | 13041664 | 13041664 | 0 | 1452176 | 1461518 | 9342 | 1 | 1 |
| `clip_state_cache_ab` | 36.900 | `yes` | 13041664 | 13041664 | 0 | 1461748 | 1471218 | 9470 | 1 | 1 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.id_mask_compositor.current_vs_legacy_upload` | 0.092 | 0.183 | 2.000 | 12 | 12 | 1120 | 308320 | 9600 | 307200 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload.current_dirty_vs_legacy_full` | 0.042 | 2.725 | 65.400 | 16384 | 4194304 | 11914 | 22208 | 1.864 | 0.025 | 0.100 | 4.000 | 16384 | 262144 | 28248 | 27790 | 0.984 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload_scratch.current_reuse_vs_legacy_temp_alloc` | 0.392 | 0.408 | 1.043 | 0 | 72 | 0 | 884736 | 4194304 | 4194304 | 786432 | 786432 | 24 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.effect_uniform.batched_vs_legacy_write_each` | 0.200 | 0.192 | 0.958 | 1353295 | 1568327 | 1.159 | 1 | 48 | 48 | 48 | 48 | 48 | 48 | 48 | 51 | 51 |
...
| --- | --- | ---: | ---: | ---: | --- |
| `app` | 320x240 | 0 | 0 | 0.000 | `/tmp/oxide-webgpu-browser-js-heap-attribution.png` |
