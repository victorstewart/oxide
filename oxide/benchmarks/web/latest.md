...
| --- | --- |
| Status | `collected` |
| Artifact | `/tmp/oxide-webgpu-browser-static-pipeline-prewarm.json` |
| Capture phase | `benchmark-report` |
| Timing source | `untraced-baseline-report` |
| Events | `66330` |
| GPU-related events | `42636` |
| WebGPU/Dawn events | `1368` |
| ANGLE events | `1` |
| Renderer events | `450` |
| Duration us | `1714822` |
| Category count | `25` |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `frame_loop` | 29532 | 2571 | 1630 | 53 | 24 | 241163 |
| `id_mask_ab` | 107523 | 5139 | 3503 | 101 | 47 | 696332 |
| `upload_ab` | 233172 | 8604 | 6072 | 179 | 56 | 1493030 |
| `upload_scratch_ab` | 66589 | 3667 | 2735 | 92 | 18 | 614304 |
| `effect_uniform_ab` | 266523 | 4320 | 2919 | 90 | 18 | 1850302 |
| `backdrop_batch_ab` | 99794 | 3656 | 2709 | 90 | 18 | 489699 |
| `scene3d_ab` | 133266 | 7065 | 5396 | 176 | 41 | 437810 |
| `mixed_matrix` | 66435 | 3463 | 2654 | 90 | 18 | 361832 |
| `layer_effects_matrix` | 66562 | 3485 | 2658 | 90 | 18 | 422980 |
| `command_family_matrix` | 65667 | 3551 | 2691 | 91 | 18 | 311591 |
| `draw_state_cache_ab` | 67045 | 3509 | 2666 | 90 | 18 | 419555 |
| `clip_state_cache_ab` | 67003 | 3557 | 2683 | 90 | 18 | 293033 |

## Benchmark Marks

| Mark | Duration ms | Trace label | WASM before bytes | WASM after bytes | WASM growth bytes |
| --- | ---: | --- | ---: | ---: | ---: |
| `frame_loop` | 37.500 | `yes` | 13041664 | 13041664 | 0 |
| `id_mask_ab` | 132.700 | `yes` | 13041664 | 13041664 | 0 |
| `upload_ab` | 233.200 | `yes` | 13041664 | 13041664 | 0 |
| `upload_scratch_ab` | 66.000 | `yes` | 13041664 | 13041664 | 0 |
| `effect_uniform_ab` | 267.100 | `yes` | 13041664 | 13041664 | 0 |
| `backdrop_batch_ab` | 99.900 | `yes` | 13041664 | 13041664 | 0 |
| `scene3d_ab` | 133.400 | `yes` | 13041664 | 13041664 | 0 |
| `mixed_matrix` | 66.500 | `yes` | 13041664 | 13041664 | 0 |
| `layer_effects_matrix` | 66.600 | `yes` | 13041664 | 13041664 | 0 |
| `command_family_matrix` | 66.600 | `yes` | 13041664 | 13041664 | 0 |
| `draw_state_cache_ab` | 66.500 | `yes` | 13041664 | 13041664 | 0 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.id_mask_compositor.current_vs_legacy_upload` | 0.108 | 0.183 | 1.692 | 12 | 12 | 1120 | 308320 | 9600 | 307200 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload.current_dirty_vs_legacy_full` | 0.050 | 2.742 | 54.833 | 16384 | 4194304 | 12082 | 30290 | 2.507 | 0.025 | 0.108 | 4.333 | 16384 | 262144 | 28790 | 29874 | 1.038 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.upload_scratch.current_reuse_vs_legacy_temp_alloc` | 0.375 | 0.408 | 1.089 | 0 | 72 | 0 | 884736 | 4194304 | 4194304 | 786432 | 786432 | 24 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.effect_uniform.batched_vs_legacy_write_each` | 0.192 | 0.208 | 1.087 | 1749200 | 1862561 | 1.065 | 1 | 48 | 48 | 48 | 48 | 48 | 48 | 48 | 51 | 51 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.scene3d.reused_mesh_vs_recreate_mesh` | 0.025 | 0.025 | 1.000 | 0 | 2 | 0 | 4 | 0 | 0 | 0 | 0 | 2 | 2 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.draw_state_cache.current_vs_legacy_rebind` | 0.142 | 0.242 | 1.706 | 1024 | 1024 | 1 | 1024 | 1 | 1024 | 1 | 1024 |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `web.wasm.webgpu.clip_state_cache.current_vs_legacy_rebind` | 0.067 | 0.133 | 2.000 | 512 | 512 | 2 | 2 | 1 | 512 | 1 | 512 | 16 | 512 |

## Pixel Check

| Target | Viewport | Pixdiff | Max Err | MSE | Artifact |
| --- | --- | ---: | ---: | ---: | --- |
| `app` | 320x240 | 0 | 0 | 0.000 | `/tmp/oxide-webgpu-browser-static-pipeline-prewarm.png` |
