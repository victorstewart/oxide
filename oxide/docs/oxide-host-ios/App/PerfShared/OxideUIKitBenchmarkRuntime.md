...
- UIKit launch tests wait on the app window and lifecycle handshakes; the launch root and ready label carry no accessibility-only test identifiers.
...
## Changelog
- 2026-08-06: removed launch-only accessibility identifiers and switched XCTest readiness to the application window.
