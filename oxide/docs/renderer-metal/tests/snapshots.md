...
- sRGB RGBA upload channel preservation.
...
## Runtime-image upload snapshot

`snapshot_rgba_image_upload_preserves_red_and_blue_channels` proves RGBA source bytes reach the sRGB texture without a red/blue swap.

## Preconditions and postconditions

The tests require a readback-capable Metal target. Passing the solid case proves the existing single-draw path resolves zero before raster interpolation. Passing the runtime-image case proves RGBA channel preservation.
...
## Changelog
- 2026-08-06: added RGBA channel-order readback coverage.
