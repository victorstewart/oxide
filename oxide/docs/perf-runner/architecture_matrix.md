...
- The warm static ID-mask report contract requires one cache hit, zero raster/seed/jump work, one compositor/total pass, one resident entry, and residency no greater than the reported hard budget.
