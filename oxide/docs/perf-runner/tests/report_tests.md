...
- `canonical_workspace_reports_use_one_atomic_promotion()`: freezes canonical JSON/latest-Markdown/dated-Markdown publication behind one staged promotion call.
