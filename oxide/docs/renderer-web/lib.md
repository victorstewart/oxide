...
- 2026-06-02: added retained clean-layer reuse in WebGPU plus clean-versus-dirty browser A/B coverage.
...
- 2026-06-02: added browser WebGPU glyph-run current-versus-legacy-rebind A/B coverage for atlas-backed A8 and SDF text draw commands.
