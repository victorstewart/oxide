...
pub struct WebRendererStats {
    ...
    pub scene3d_bind_group_binds: u32,
...
impl Default for WebRendererStats {
    fn default() -> Self {
        Self {
            ...
            glyph_instances: 0,
            glyph_triangles: 0,
            glyph_instance_bytes: 0,
            glyph_instance_buffer_binds: 0,
            layer_draws: 0,
            layer_cache_hits: 0,
            ...
            scene3d_draws: 0,
            scene3d_instances: 0,
            scene3d_instance_bytes: 0,
            scene3d_pipeline_binds: 0,
            scene3d_bind_group_binds: 0,
            scene3d_mesh_buffer_binds: 0,
            scene3d_viewport_sets: 0,
            id_mask_draws: 0,
            ...
            effect_graph_effects: 0,
            effect_graph_captures: 0,
            effect_graph_pyramids: 0,
            effect_graph_pyramid_reuses: 0,
            effect_graph_plan_reuses: 0,
            effect_graph_capture_passes: 0,
            effect_graph_downsample_passes: 0,
            effect_graph_blur_horizontal_passes: 0,
            effect_graph_blur_vertical_passes: 0,
            effect_graph_composite_passes: 0,
            effect_graph_max_lifetime_commands: 0,
            effect_graph_resources: 0,
            effect_graph_alias_slots: 0,
            effect_graph_logical_bytes: 0,
            effect_graph_physical_bytes: 0,
            effect_graph_aliased_bytes: 0,
