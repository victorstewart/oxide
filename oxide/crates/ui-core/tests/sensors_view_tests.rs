...
use oxide_platform_api::{LocationEvent, LocationReading, PermissionDomain, PermissionStatus};
use oxide_test_scenes::Router;
use oxide_ui_core::SensorBridgeConfig;
use std::sync::{
...
impl oxide_ui_core::elements::ImageUploader for DummyUploader {
    fn create_a8(
        ...
        oxide_renderer_api::ImageHandle(0)
    }
...
fn router_exposes_sensor_snapshot() {
    ...
    let bridge = Arc::new(oxide_permissions::SensorBridge::new_with_config(
        clock,
