...
pub use retained::{
   ...
   RenderDynamicClip, RenderEffectDependency, RenderFallbackStats, RenderLayerInstance,
   RenderPaintSpan, RenderPropertySlot, RenderPropertySlotId, RenderPropertyValue,
   RenderResolvedInstance, RenderResourceDependency, RenderSnapshot, RenderSnapshotError,
   RenderSpatialBounds, RenderSpatialQueryStats,
};
