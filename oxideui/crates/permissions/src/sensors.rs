...
struct PermissionCache {
    statuses:
        HashMap<oxideui_platform_api::PermissionDomain, oxideui_platform_api::PermissionStatus>,
}

impl PermissionCache {
    fn set(
        &mut self,
        domain: oxideui_platform_api::PermissionDomain,
        status: oxideui_platform_api::PermissionStatus,
    ) {
    ...
    fn get(
        &self,
        domain: oxideui_platform_api::PermissionDomain,
    ) -> Option<oxideui_platform_api::PermissionStatus> {
