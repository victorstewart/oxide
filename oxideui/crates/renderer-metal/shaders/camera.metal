...
struct CamVSOut { float4 position [[position]]; uint iid; };
                                ...
                                constant CamVPSize& vp [[buffer(1)]])
{
    ...
    CamVSOut o; o.position = float4(clip, 0.0, 1.0); o.iid = iid; return o;
}

struct CamParams {
    float4 rect;      // x,y,w,h in pixels (framebuffer space)
