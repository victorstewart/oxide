use oxideui_platform_api::{KeyboardEvent, KeyboardGeometry, KeyboardTransition};
use oxideui_ui_core::keyboard::{KeyboardEventExt, KeyboardTracker};
...
fn tracker_updates_geometry_and_notifies() {
    ...
    let transition = KeyboardTransition {
        geometry: KeyboardGeometry {
            visible: true,
            frame: oxideui_renderer_api::RectF::new(0.0, 400.0, 320.0, 260.0),
            overlap_insets: oxideui_renderer_api::Insets::new(0.0, 0.0, 0.0, 240.0),
        },
        animation_ms: 250,
    };
